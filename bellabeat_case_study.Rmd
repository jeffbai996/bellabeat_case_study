...
One important caveat to note is, since we have little information on the 33 individuals represented in the dataset (no age, gender, etc.), results may be skewed if the sample is not representative of the general population of smart tracker users.
...
**Current?**  
This dataset was last updated 2 years ago and is not current. At the same time, usage patterns for smart devices that have been established since they were first introduced to market are unlikely to change in the absence of groundbreaking technology in this space.

**Cited?**  
This dataset's source, authors, and collection method are well documented and can be found on the dataset's Kaggle page.
