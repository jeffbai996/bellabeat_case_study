...
....add comments and code chunks here....

And finally, we will skim weightLogInfo:

```{r, eval=FALSE, message=FALSE}
skim_without_charts(weightLogInfo, !id)
```
...
── Variable type: numeric ──────────────────────────────────────────────────────────────────────────
  skim_variable n_missing complete_rate    mean           sd      p0     p25     p50     p75    p100
1 weight_kg             0        1      7.20e 1        13.9  5.26e 1 6.14e 1 6.25e 1 8.50e 1 1.34e 2
2 weight_pounds         0        1      1.59e 2        30.7  1.16e 2 1.35e 2 1.38e 2 1.88e 2 2.94e 2
3 fat                  65        0.0299 2.35e 1         2.12 2.2 e 1 2.28e 1 2.35e 1 2.42e 1 2.5 e 1
4 bmi                   0        1      2.52e 1         3.07 2.15e 1 2.40e 1 2.44e 1 2.56e 1 4.75e 1
5 log_id                0        1      1.46e12 782994784.   1.46e12 1.46e12 1.46e12 1.46e12 1.46e12
```
....add comments and code chunks here....
